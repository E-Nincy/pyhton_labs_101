...
and I got no reply, because it's a chicken and chickens don't speak I remembered. and with that realisation I woke up....
This is not even the strangest dream I've had this week, however now I want an omelet.
So I use my magic amulet to conjure the most delicious omelette I can think of. Only, instead of an omelette, I get ... 
a small, furry creature with big, round eyes staring back at me. It looks like a cross between a bunny and a hamster, and it's sitting right where my omelette should be and then ...
"You will never be able to conjure up a delicious omelette," echoes the words of my former magic teacher.
...It was in this instant that a flashback appeared in my mind to my freshman year of highschool I was in magic class unable to conjure an omlet! Everyone stood there laughing at me, and I failed
my magic exam as well as the class thanks to my evil teacher Harrithan Plotters with his lightning shaped mole and his silly monocle. But this time I'll show them all!! I picked up the amulet and with all my might I shouted "WINGED GUARDIAN LEVI-O-SUUUUHHHHHHHHH!!" every single light bulb exploded and sparks shot out of the sockets and to my amazement once the smoke cleared....

there it was, the biggest, ugliest, hairiest creature I've ever seen in my life! I was in shock, I couldn't believe I was standing in front of a ....
...
in a short while, i quickly think of a way to come out of it and freely free myself and realised all problems has a specific solution ....
...was it all a dream, is anything even real? Horatio, the milk, the never ending sandwich...whatever it is/was, chaos lives here.
...
But when I realised I was mistaken and that the best approach to vanquish the most evil of all was...UPS! Suddenly i woke up and found myself floating. Disoriented, I flailed my arms, limbs meeting only air. Panic surged through me, but then I realized I wasn't falling. Confused, I sat up and realised that I was still in my room. The room was dark but there was a gentle wormth surrounded me, and a soothing voice whispered, "it was just a dream.. or was it"...]
"""
translated_text = ""
current_word = ""
...
for char in story_text:
    if char.isalpha():  
        ...
        # Translate it to pig latin if it's not empty.
        if current_word:
            translated_word = current_word[1:] + current_word[0] + "ay"
            translated_text += translated_word
            current_word = ""
        # Add the non-letter character
        translated_text += char

# Handle the last word if the text doesn't end in punctuation
if current_word:
    translated_word = current_word[1:] + current_word[0] + "ay"
    translated_text += translated_word
