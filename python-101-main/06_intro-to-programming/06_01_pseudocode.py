...
# Save names of the kittens
Kittens = ["Cloe", "Oreo", "Coco"]
# Confirm that each of them is cute
Confirm =  ("is really cute and fluffy")
# Show that the Kittens are raedy
message = ("and is ready for adoption!")

for name in Kittens :
    print(name, Confirm, message)
